...
#include "gray_filter/gray_filter.h"
/*===========================================================================
 *  Platform glue
 *===========================================================================*/
...
{
	xil_printf("\r\n--- keys ---------------------\r\n");
	xil_printf(" g : toggle grayscale / color \r\n");
	xil_printf(" 1 : grayscale on \r\n");
	xil_printf(" 0 : grayscale off \r\n");
	xil_printf(" b : toggle bin filter / color \r\n");
	xil_printf(" ? : help \r\n");
}
...
static void menu_run()
{
	...
	switch(c)
	{
	case 'g' : gray_toggle(); break;
	case '1' : gray_set(1);	break;
	case '0' : gray_set(0);	break;
	case 'b' : bin_toggle(); break;
	case '?' : menu_help();
	default:	break;
	}
}
