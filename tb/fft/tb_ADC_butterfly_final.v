...
module tb_ADC_butterfly_final;
    localparam ADC_FILE = "fft_input_10000hz_clean.mem";
    ...
    task calculate_expected;
        begin
            ...
            tr=(br*wr-bi*wi) >>> 14;
            ti=(br*wi+bi*wr) >>> 14;
            check(tr>=-1048576 && tr<=1048575 &&
                  ti>=-1048576 && ti<=1048575,"T exceeds signed 21-bit range");
            r0=ar+tr; i0=ai+ti;
            r1=ar-tr; i1=ai-ti;
    ...
    initial begin
        ...
        $display("EXCLUDES: reset, input loading/bit reversal, Power, external stalls and physical timing verification.");
        $finish;
    end
