...
##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { start_btn[0] }]; #start_btn[0]
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { start_btn[0] }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
